var reference = setInterval(fuckYouShots,1000);
...
if (n > 0) console.log(timeStamp() + " : No tickets found");
	...
	signedOut = 've signed out.<br /><br />Thanks for visiting SHOTS Student Ticketing!</b></td></tr>';
	if (x.search(signedOut) < 0) {
		...
		makeNoise();
		alert("Refresh token renewal failed");
	}
}
}
